<?php
	...
	if($vw_photography_first_color != false){
		$custom_css .='a, #footer h3, #footer .custom-social-icons i:hover, .search-box i, .woocommerce-info::before, .woocommerce-message::before, .post-main-box:hover h3 a, .post-navigation a:hover .post-title, .post-navigation a:focus .post-title,#footer li a:hover{';
	...
	if($vw_photography_second_color != false){
		$custom_css .='#header, #header .nav ul li:hover > ul li a, #footer, #sidebar .custom-social-icons i:hover, .pagination .current, .pagination a:hover, .woocommerce #respond input#submit:hover, .woocommerce a.button:hover, .woocommerce button.button:hover, .woocommerce input.button:hover, .woocommerce #respond input#submit.alt:hover, .woocommerce a.button.alt:hover, .woocommerce button.button.alt:hover, .woocommerce input.button.alt:hover, .woocommerce span.onsale{';
			$custom_css .='background-color: '.esc_html($vw_photography_second_color).';';
		$custom_css .='}';
	}
	if($vw_photography_second_color != false){
		$custom_css .='a:hover, .page-template-custom-home-page #header .nav ul li a, .page-template-custom-home-page .logo h1 a, .page-template-custom-home-page p.site-description, .cat-page-box h3, .cat-page-box i, .content-vw h1, .post-main-box h3 a, #sidebar h3, h2.woocommerce-loop-product__title, .woocommerce div.product .product_title, .woocommerce ul.products li.product .price, .woocommerce div.product p.price, .woocommerce div.product span.price, .content-vw h2, .post-info, h2#reply-title, .post-navigation a, h1, h2, h3, h4, h5, h6{';
